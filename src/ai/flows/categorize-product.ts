...
const categorizeProductPrompt = ai.definePrompt({
  ...
  prompt: `Eres un asistente de categorización de productos para una aplicación de gestión de despensa. Tu única función es asignar una categoría a un producto de una lista estrictamente definida, pensando en cómo se usa y almacena en un hogar.
...
2.  Analiza el nombre del producto: "{{{productName}}}"
...
- Producto: "Yogur griego" -> {"category": "Lácteos y Huevos"}
- Producto: "Bistec de ternera" -> {"category": "Proteínas"}
- Producto: "Galletas saladas" -> {"category": "Aperitivos"}
- Producto: "Refresco de cola" -> {"category": "Bebidas"}
- Producto: "Manzanilla en infusión" -> {"category": "Bebidas"}
- Producto: "Té negro" -> {"category": "Bebidas"}
- Producto: "Servilletas de papel" -> {"category": "Hogar y Limpieza"}
- Producto: "Manzanas" -> {"category": "Frutas y Verduras"}
- Producto: "Pan de molde" -> {"category": "Panadería y Cereales"}
- Producto: "Atún en aceite de oliva" -> {"category": "Conservas y Despensa"}
- Producto: "Pimienta negra" -> {"category": "Condimentos y Especias"}
